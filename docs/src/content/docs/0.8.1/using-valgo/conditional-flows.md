...
description: Build conditional Go validation flows with Valgo by merging
  validations and executing callbacks in validation chains.
slug: 0.8.1/using-valgo/conditional-flows
---
