...
See [OR operators](/0.8.1/validators/or-operators/),
[conditional validation](/0.8.1/using-valgo/conditional-flows/), and
[namespaces](/0.8.1/using-valgo/namespaces/) for the detailed behavior.
...
See [Namespaces](/0.8.1/using-valgo/namespaces/) and
[Slices and indexed errors](/0.8.1/cookbook/slices/) for complete examples.
