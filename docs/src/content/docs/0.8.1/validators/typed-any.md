...
description: Validate arbitrary Go values with Valgo typed validators, dynamic
  predicates, equality checks, nil checks, and custom rules.
slug: 0.8.1/validators/typed-any
---
