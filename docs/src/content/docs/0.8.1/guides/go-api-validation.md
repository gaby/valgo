...
description: Validate Go API request payloads with Valgo and return structured
  field errors for JSON clients.
slug: 0.8.1/guides/go-api-validation
---
...
See [Go Validation Errors and JSON Output](/0.8.1/using-valgo/errors/) for output options and [Go Sign-up Form Validation](/0.8.1/cookbook/signup-form/) for a complete request-style example.
...
For arrays or repeated fields, see [Validate Go Slices and Indexed Errors](/0.8.1/cookbook/slices/).
