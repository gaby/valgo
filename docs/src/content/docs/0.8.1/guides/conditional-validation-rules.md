...
description: Write conditional Go validation rules with Valgo when validation
  depends on business logic, previous results, or runtime state.
slug: 0.8.1/guides/conditional-validation-rules
---
...
For the API surface, see [Conditional Validation in Go](/0.8.1/using-valgo/conditional-flows/) and [Conditional Validation Rules in Go](/0.8.1/cookbook/conditional-rules/).
