...
slug: 0.8.1/guides/go-validation-without-struct-tags
---
...
For a first example, start with [Getting Started](/0.8.1/getting-started/). For reusable validation functions, see [Reusable Go Validation Functions](/0.8.1/cookbook/reusable-validations/).
...
For deeper examples, see [Validate Nested Structs in Go](/0.8.1/cookbook/nested-structs/) and [Validate Go Slices and Indexed Errors](/0.8.1/cookbook/slices/).
