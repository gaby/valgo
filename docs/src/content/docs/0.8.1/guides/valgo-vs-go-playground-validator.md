...
description: Compare Valgo and go-playground/validator for Go validation,
  including struct tags, type safety, conditional rules, and error output.
slug: 0.8.1/guides/valgo-vs-go-playground-validator
---
...
* [Go Validation Without Struct Tags](/0.8.1/guides/go-validation-without-struct-tags/)
* [Conditional Validation in Go](/0.8.1/using-valgo/conditional-flows/)
* [Go Validation Errors and JSON Output](/0.8.1/using-valgo/errors/)
* [Localized Go Validation Messages](/0.8.1/using-valgo/localization/)
