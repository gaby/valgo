...
description: Gate Valgo validation rules in Go based on business logic, previous
  validity, and conditional input requirements.
slug: 0.9.0/cookbook/conditional-rules
---
