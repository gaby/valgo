...
slug: 0.9.0/guides/go-api-validation
---
...
See [Go Validation Errors and JSON Output](/0.9.0/using-valgo/errors/) for output options and [Go Sign-up Form Validation](/0.9.0/cookbook/signup-form/) for a complete request-style example.
...
For arrays or repeated fields, see [Validate Go Slices and Indexed Errors](/0.9.0/cookbook/slices/).
