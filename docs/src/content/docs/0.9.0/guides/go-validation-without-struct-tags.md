...
description: Learn how to validate Go values without struct tags using Valgo
  function-based validation chains.
slug: 0.9.0/guides/go-validation-without-struct-tags
---
...
For a first example, start with [Getting Started](/0.9.0/getting-started/). For reusable validation functions, see [Reusable Go Validation Functions](/0.9.0/cookbook/reusable-validations/).
...
For deeper examples, see [Validate Nested Structs in Go](/0.9.0/cookbook/nested-structs/) and [Validate Go Slices and Indexed Errors](/0.9.0/cookbook/slices/).
