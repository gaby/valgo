...
description: Use Valgo namespaces with In(), InRow(), and InCell() to validate
  nested structs, slices, and structured error paths in Go.
slug: 0.9.0/using-valgo/namespaces
---
