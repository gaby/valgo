...
description: Learn how Valgo validation sessions validate one or many Go values
  and collect structured validation results.
slug: 0.9.0/using-valgo/validation-sessions
---
