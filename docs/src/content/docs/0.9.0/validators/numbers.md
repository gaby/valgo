...
description: Validate Go numeric values and pointers with Valgo generic
  validators, comparison rules, range checks, and type-specific helpers.
slug: 0.9.0/validators/numbers
---
...
Use the [`is` predicate package](/0.9.0/validators/predicates/) when you need the
